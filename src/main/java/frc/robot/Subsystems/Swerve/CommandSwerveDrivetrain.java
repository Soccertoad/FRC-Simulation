...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
  ...
  public SwerveControllerCommand getAutoCommand(Trajectory trajectory) {
    ...
    ProfiledPIDController thetaController = SwerveConstants.AutoConstants.thetaController;
    thetaController.enableContinuousInput(-Math.PI, Math.PI);

    return new SwerveControllerCommand(trajectory, this::getPose, SwerveConstants.Swerve.swerveKinematics,
        new HolonomicDriveController(
            new PIDController(SwerveConstants.AutoConstants.kPXController, 0,
                SwerveConstants.AutoConstants.kPXController / 2),
  ...
  public ChassisSpeeds getRobotRelativeChassisSpeeds() {
    return SwerveConstants.Swerve.swerveKinematics.toChassisSpeeds(getState().ModuleStates);
  }
